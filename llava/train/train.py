...
class ModelArguments:
    ...
    mm_vision_tower_type: Optional[str] = field(
        default=None,
        metadata={"help": "Vision tower type (e.g., 'cl4d' for CL4D motion encoder)"},
    )
...
class DataArguments:
    ...
    use_motion_data: bool = field(
        default=True, metadata={"help": "Use motion sequences instead of images"}
    )
    vqa_path: Optional[str] = field(
        default=None, metadata={"help": "Path to VQA annotations directory"}
    )
    motion_path: Optional[str] = field(
        default=None, metadata={"help": "Path to motion sequences directory"}
    )
...
def train(attn_implementation=None):
    ...
    if data_args.use_motion_data:
        from src.datasets.DynAction4D_VQA import make_motion_supervised_data_module

        data_module = make_motion_supervised_data_module(
