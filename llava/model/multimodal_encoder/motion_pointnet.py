...
from llava.model.multimodal_encoder.motion_point_net_module.models import MotionPointNet
...
class MotionPointNetVisionTower(nn.Module):
    ...
    def __init__(self, vision_tower, args, delay_load=False):
        """
        Args:
            vision_tower: str, path to checkpoint directory (e.g., "output/DynAction4DHuman/MotionPointNet")
