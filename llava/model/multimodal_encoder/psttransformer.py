...
from llava.model.multimodal_encoder.pst_transformer_module.models import PSTTransformer
...
class PSTTransformerVisionTower(nn.Module):
    ...
    def __init__(self, vision_tower, args, delay_load=False):
        """
        Args:
            vision_tower: str, path to checkpoint directory (e.g., ""output/DynAction4DHuman/PSTTransformer")
