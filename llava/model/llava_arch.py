...
class LlavaMetaModel:
    ...
    def initialize_vision_modules(self, model_args, fsdp=None):
        ...
        mm_vision_tower_type = getattr(model_args, "mm_vision_tower_type", None)
        ...
        if mm_vision_tower_type is not None:
            self.config.mm_vision_tower_type = mm_vision_tower_type
        ...
        if needs_rebuild or getattr(self, "mm_projector", None) is None:
            print(
                f"Building projector: {vision_tower.hidden_size} -> {self.config.hidden_size}"
            )
        ...
        if pretrain_mm_mlp_adapter is not None:
            ...
            print(
                f"✓ Loaded pretrained mm_projector adapter weights from {pretrain_mm_mlp_adapter}"
            )
