...
class DynAction4DHuman(torch.utils.data.Dataset):
    """
    DynAction4DHuman dataset for Human Motion Sequences with Windowed Augmentation.
    ...
    def __init__(self, 
        ...
        Args:
            ...
            no_normalize: If True, do not normalize the point clouds.
